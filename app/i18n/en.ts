...
const en = {
  ...
  historyScreen: {
    ...
    downloadYourData: "Save your training data to your phone",
    uploadYourData: "Upload your ai'titude data",
    ...
    deleteMessage: "This will delete all your training history",
